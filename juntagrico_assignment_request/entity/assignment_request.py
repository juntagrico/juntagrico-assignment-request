...
class AssignmentRequest(models.Model):
    ...
    def get_matching_job_type(self):
        ...
        values = {x: getattr(self, x) for x in ['activityarea', 'location']}
        values['location'] = values['location'] or '-'  # location can not be empty in job
        values['default_duration'] = self.duration
